    ...
    <div>
      ...
      <div className="py-8 bg-gray-100 flex flex-col items-center text-center">
        <div className="relative w-60 h-60 sm:w-80 sm:h-80 rounded-full overflow-hidden">
          <Image
            src="/restauranteImg/naturals.png"
            alt="Logo do Restaurante Naturals"
            fill
            className="object-cover"
          />
        </div>
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-4">Restaurante Naturals</h1>
        <p className="text-md sm:text-lg text-gray-600 mt-4 max-w-lg">
          Bem-vindo ao Naturals! Aqui você encontra uma seleção deliciosa de pratos, petiscos e bebidas, preparados com carinho e qualidade.
        </p>
