    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md p-6 bg-white rounded shadow-md">
        ...
        <div className="space-y-4">
          ...
          <div>
            <h1 className="font-semibold mb-2 text-black">Logo do Restaurante</h1>
          </div>
          <input
            type="file"
            accept="image/*"
      ...
      {mostrarPopup && (
        <div className="fixed inset-0 backdrop-blur-sm bg-black/20 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-md max-w-sm text-center">
            ...
            <p className="mb-4">Enviamos um link para o e-mail cadastrado. Clique em OK para continuar.</p>
            <button
              onClick={() => router.push('/CadastroRestaurante/LoginRestaurante')}
